...
<template>
    <section
        class="relative text-white h-screen w-screen flex items-center justify-center overflow-hidden">

        <!-- Background image and blue opacity layer -->
        <div class="absolute inset-0">
            <img src="/img/bot_hero_image.png" alt="Background Image" class="object-cover object-center w-full h-full" />
        ...
        <div class="text-center p-8 font-main flex items-center flex-col z-10">
            <svgBotWithText class="h-[200px] w-[200px] xl:h-[300px] xl:w-[300px] lg:w-[200px]" :text-fill-color="'#F9B666'"/>
            <h1 class="text-2xl lg:text-4xl font-bold mb-4">Die Plattform für die digitale Präsenz eurer Stadt/Destination</h1>
            ...
            <div class="flex">
                <div class="relative group">
                    ...
                    <NuxtLink class="ml-2 hover:text-white hover:cursor-pointer" :to="'/download'">
