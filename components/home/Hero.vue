...
<template>
    <section
        ...
        <div class="absolute inset-0">
            <img src="/img/home_hero_bw.jpg" alt="Background Image" class="object-cover object-center w-full h-full" />
        ...
        <div class="text-center p-8 font-main flex items-center flex-col z-10">
            <svgLogo class="h-24 lg:h-48 mb-8" />
            <h1 class="text-3xl lg:text-5xl font-bold mb-4">DestinationBase is the platform to run your destination
                digital</h1>
