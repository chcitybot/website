---
title: "SCCON 2025 in Berlin: Why Digitalization Is Now a National Priority"
description: "CityBot at the Smart Country Convention 2025 — how Germany and Switzerland are shaping the future of smart cities together."
...
We experienced this momentum firsthand at the **Smart Country Convention (SCCON) 2025** in Berlin, Europe's leading event for public sector digitalization. From September 30 to October 2, decision-makers from politics, administration, science, and technology came together with one goal: to make cities and public services smarter, faster, and more citizen-centric.

And the guiding principle? **"Copying is encouraged!"** — a refreshingly honest motto that puts collaboration above competition.
...
This philosophy was at the heart of SCCON 2025. Among the many inspiring projects presented, three Swiss initiatives stood out — each embodying this collaborative spirit.
...
Germany is leading by example with a ministry that treats digitalization as infrastructure — as essential as roads and energy. But this trend is not limited to Germany. Across Europe and beyond, cities face the same challenges:

- **Visitors expect digital experiences** — from personalized recommendations to AI-powered city guides.
- **Budgets are tight** — shared platforms reduce costs dramatically compared to custom-built solutions.
- **Data-driven decisions** are replacing guesswork in tourism management and urban planning.
- **Sustainability** demands smarter visitor flows and less printed material.

CityBot addresses all of these. As a platform for the digital presence of cities and destinations, it gives municipalities a ready-to-use solution for **smart tourism** — complete with AI-powered recommendations, curated tours, and measurable impact.
...
**Ready to make your city digitally accessible?** [Discover how CityBot can help →](https://citybot.ch/en)
